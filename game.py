...
def play_game(level):
    ...
    while attempts < max_attempts and points > 0:
        ...
        try:
            choice = int(input("➡️ Masukkan pilihan: "))
        except ValueError:
        ...
        if choice == 2:
            ...
            if guess_number == secret_number:
                ...
                print(f"3. ⏱️ Lama waktu mencoba menebak: {duration:.2f} detik")
                ...
                print("❌ Tebakan Anda salah: terlalu rendah. ⬇️")
            else:
                print("❌ Tebakan Anda salah: terlalu tinggi. ⬆️")
...
def main():
    ...
    while True:
        ...
        try:
            level = int(input("➡️ Masukkan level (1-4): "))
            if level == 4:
